 ...
 */
@Entity
@Table(name = "WL_WM_NOTICE_IN")
public class WlWmNoticeIn extends BaseModel implements java.io.Serializable {
	 ...
	 * 入库业务类型
	 */
	@Column(name = "WM_IN_TYPE_EK")
	private String wmInTypeEk;
	...
	public void setWmInTypeEk(String wmInTypeEk) {
		this.wmInTypeEk = wmInTypeEk;
	}

	public String getWmInTypeEk() {
		return this.wmInTypeEk;
	}
	...
	public void setExpectInDate(Date expectInDate) {
		this.expectInDate = expectInDate;
	}

	public Date getExpectInDate() {
		return this.expectInDate;
	}
