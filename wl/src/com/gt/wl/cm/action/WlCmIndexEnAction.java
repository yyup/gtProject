...
@Controller
@RequestMapping("/wl/cm/WlCmIndexEnAction.dox")
public class WlCmIndexEnAction extends BaseAction {
	...
	public String init() {
		try {
			...
			List<WlCmInfoEn> wlCmInfoNewList = page.getItems();
			List newList = new ArrayList();
			for (WlCmInfoEn wlCmInfo : wlCmInfoNewList) {
			...
			List<WlCmInfoEn> wlCmInfoVideoList = page.getItems();
			List videoList = new ArrayList();
			for (WlCmInfoEn wlCmInfo : wlCmInfoVideoList) {
				Map map = new HashMap();
				String content = wlCmInfo.getContent();
...
//				// wlCmInfo.setContent(content);
	...
	public String findMyShoppingCartPage(int pageSize, int currPage, String isThumFlag, String[] sellIds) {
		try {
			...
			Page page = wlEsMyShoppingCartService.findMyShoppingCartPage(pageSize, currPage, user.getId(), isThumFlag, sellIds,"english");
