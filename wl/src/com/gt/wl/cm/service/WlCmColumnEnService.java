...
import com.gt.wl.cm.dao.WlCmColumnEnDao;
 ...
 * 
 */
@Service("wl.cm.WlCmColumnEnService")
public class WlCmColumnEnService extends BaseService {
	private WlCmColumnEnDao wlCmColumnDao = (WlCmColumnEnDao) Sc.getBean("wl.cm.WlCmColumnEnDao");

	public WlCmColumnEnService() {
	 ...
	 * @return 栏目列表
	 */
	public List<WlCmColumnEn> findAllColumnList(String isEnableFlag, String isLastFlag,String rootId) {
		try {
	...
	public void deleteColumns(String[] ids) {
		try {
			...
			if (!ValidateUtil.isEmpty(childTypeList)) {
				throw new BaseException(Lang.getString("wl.cm.WlCmColumnEnService.deleteConfirm"));
			}
	 ...
	 * @return 类型列表
	 */
	public List<WlCmColumnEn> findChildColumnList(String[] parentColumnIds, String dataState, String isEnableFlag) {
		try {
			String result = "";
	 ...
	 * @return 类型列表
	 */
	public List<WlCmColumnEn> findChildList(String[] parentColumnIds, String dataState, String isEnableFlag, String isLastFlag) {
		try {
	...
	public void updateWlCmColumnState(String[] ids, String isEnableFlag) {
		try {
			for (String id : ids) {
				WlCmColumnEn wlCmColumn = (WlCmColumnEn) this.getObject(id);
	...
	public void getInitializePage(String parentId, String isEnableFlag, String dataState, List result) {
		try {
			...
			List<WlCmColumnEn> list = wlCmColumnDao.findChildList(parentIds, dataState, isEnableFlag, "");
