...
@Repository("wl.cm.WlCmColumnDao")
public class WlCmColumnDao extends BaseDao {

	public WlCmColumnDao() {
		modelClass = WlCmColumn.class;
		defaultOrder = "";
	}
	 ...
	 * @return 栏目对象列表
	 */
	public List<WlCmColumn> findAllColumnList(String isEnableFlag, String isLastFlag,String root) {
		try {

			String hql = "from WlCmColumn where dataState='1'  ";
	 ...
	 * @return 栏目列表
	 */
	public List<WlCmColumn> findChildColumnList(String parentIds, String dataState, String isEnableFlag) {
		try {
			String hql = "from WlCmColumn  where 1=1";
	 ...
	 * @return 栏目列表
	 */
	public List<WlCmColumn> findChildList(String[] parentIds, String dataState, String isEnableFlag, String isLastFlag) {
		try {
			String hql = "from WlCmColumn  where dataState='" + dataState + "' and  parentColumnId in " + ConvertUtil.toDbString(parentIds);
			if (!ValidateUtil.isEmpty(isEnableFlag)) {
	...
	public void deleteColumns(String[] ids, String dataState) {
		String hql = "update WlCmColumn set dataState ='" + dataState + "' where columnId in " + ConvertUtil.toDbString(ids);
		try {
			this.executeHql(hql);
		}
		catch (Exception e) {
