...
<html>
 <head>
	...
	<link rel="stylesheet" href="../style/prj/newsite/acp_font_url.css" />
  </head>
<body>
   <!--头部开始-->
	<div id="top">
		 ...
		 <div class="container" style="margin-top: 250px; margin-bottom: 100px;">
	          <div class="row text-center" >
	              <div class="col-sm-12 text-center" style="height: 50px;">
	                  ...
	                  <span class="payErrorText">抱歉，系统检测到付款失败</span>
	              </div>
	          </div>
	          <div class="row text-center" >
	             <input type="button" onclick="toOrder()" value="继续付款" class="continuePay"/>
	          </div>
	          <div class="row text-center" >
	              <div class="contact">如果付款遇到问题，请电话联系客服400-600-4546（工作时间：周一至周五09:00~18:00）</div>
	          </div>
	      </div>
	      </div>
	<%
	...
	<div id="wlBody"  class="contentMargin">
 	 <div class="container" style="margin-top: 250px; margin-bottom: 180px;" >
          <div class="row" style="margin-bottom: 130px;">
              <div class="col-md-12 title text-center" >恭喜您，购买成功!</div>
          </div>
          <row>
              <div class="col-md-6"> <div style="text-align: center;"><input type="button" class="bottomButton " onclick="toOrder()" value="查看我的订单"></div></div>
              <div class="col-md-6">  <div style="text-align: center;"><input type="button" class="bottomButton"  onclick="toShop()" value="继续购买"></div></div>
          </row>
      </div>
      </div>
<%
...
%>
	...
	<script> 
		...
		function toOrder(){
			window.location="../html/newsite/hasBuyGoods.html";
		}
		function toShop(){
			window.location="../html/newsite/productCenter.html";
		}
		<%-- function init(){
